...
class MoltenEnchantment : Enchantment(NamespacedKey.minecraft("molten")), Listener {
    /**
    ...
    override fun displayName(level: Int): Component {
        return MiniMessage.miniMessage().deserialize("<gray>Molten ${EnchantmentWrapperHandler.getRomanNumeral(level)}</gray>").decoration(TextDecoration.ITALIC, false)
    }
